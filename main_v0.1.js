...
var _3MTaper,ct_3MTaper=0,speedTemp_3MTaper=0,sec_3MTaper=0,stopCount_3MTaper=0,flagStop_3MTaper=0,flagPrint_3MTaper=0,speed_3MTaper=0,time_3MTaper=0;
var actual_3MTaper=0,state_3MTaper=0;
...
var DoRead = function (){
    client.readHoldingRegisters(0,99).then(function(resp){
        var statesFiller              = switchData(resp.register[0],resp.register[1]),
            statesCapSorter           = switchData(resp.register[2],resp.register[3]),
            ...
            states_3MTaper            = switchData(resp.register[12],resp.register[13]),
          ...
          //Filler -------------------------------------------------------------------------------------------------------------
          //CapSorter -------------------------------------------------------------------------------------------------------------
            ctCapSorter = joinWord(resp.register[29],resp.register[28]);
              if(flagONS2===0){
          ...
          //CapSorter -------------------------------------------------------------------------------------------------------------
          //Capper -------------------------------------------------------------------------------------------------------------
            ctCapper = joinWord(resp.register[31],resp.register[30]);
              if(flagONS3===0){
            ...
            Capper = {
                ...
                CPQR: joinWord(resp.register[35],resp.register[34]),
                SP: speedCapper
            };
          ...
          //Capper -------------------------------------------------------------------------------------------------------------
          //Depuck -------------------------------------------------------------------------------------------------------------
            ctDepuck = joinWord(resp.register[37],resp.register[36]);
              if(flagONS4===0){
          ...
          //Labeller -------------------------------------------------------------------------------------------------------------
          //Shrinkwrapper -------------------------------------------------------------------------------------------------------------
            ctShrinkwrapper = joinWord(resp.register[47],resp.register[46]);
              if(flagONS6===0){
          ...
          //Shrinkwrapper -------------------------------------------------------------------------------------------------------------
          //_3MTaper -------------------------------------------------------------------------------------------------------------
            ct_3MTaper = joinWord(resp.register[51],resp.register[50]);
              if(flagONS7===0){
          ...
          //Checkweigher -------------------------------------------------------------------------------------------------------------
          //Printer -------------------------------------------------------------------------------------------------------------
            ctPrinter = joinWord(resp.register[61],resp.register[60]);
              if(flagONS9===0){
            ...
            Printer = {
                ...
                CPQR: joinWord(resp.register[65],resp.register[64]),
                SP: speedPrinter
            };
          ...
          //Printer -------------------------------------------------------------------------------------------------------------
          //Paletizer -------------------------------------------------------------------------------------------------------------
            ctPaletizer = joinWord(resp.register[67],resp.register[66]);
              if(flagONS10===0){
            ...
            Paletizer = {
                ST: statePaletizer,
                CPQI: joinWord(resp.register[67],resp.register[66]),
                //CPQO: joinWord(resp.register[63],resp.register[62]),
                //CPQR: joinWord(resp.register[65],resp.register[64]),
                SP: speedPaletizer
            };
